...
import com.ritualsoftheold.terra.manager.MemoryArea;
import com.ritualsoftheold.terra.manager.chunk.ChunkType;
import com.ritualsoftheold.terra.manager.chunk.TooManyMaterialsException;
...
public class Palette16ChunkFormat implements ChunkFormat {
    ...
    public class Palette16CriticalBuffer implements CriticalBlockBuffer {
        ...
        public Storage getStorage() {
            return new Storage(ChunkFormat.forType(ChunkType.PALETTE16), area); // TODO
        }
